...
class PositionsHistoryService:
    ...
    async def get_positions_history(self, start: Optional[int] = None, end: Optional[int] = None, limit: int = 50) -> List[PositionHistory]:
        """
    ...
    async def get_positions_audit(self, symbol: str, start: Optional[int] = None, end: Optional[int] = None, limit: int = 50) -> List[PositionHistory]:
        """
        ...
        """
        try:
            endpoint = f"auth/r/positions/audit"
...
async def get_positions_history(start: Optional[int] = None, end: Optional[int] = None, limit: int = 50) -> List[PositionHistory]:
...
async def get_positions_audit(symbol: str, start: Optional[int] = None, end: Optional[int] = None, limit: int = 50) -> List[PositionHistory]:
