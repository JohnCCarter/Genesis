...
class HtmlApiExtractor:
    ...
    def _check_authentication(self, section: BeautifulSoup) -> bool:
        ...
        auth_words = ['authenticated', 'requires auth', 'authorization required', 'api key']
    ...
    def _extract_parameters(self, section: BeautifulSoup) -> List[Dict[str, Any]]:
        ...
        param_section = section.find(['table', 'div', 'ul'], class_=['parameters', 'params', 'arguments', 'api-parameters'])
