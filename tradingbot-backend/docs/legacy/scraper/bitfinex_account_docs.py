...
class BitfinexAccountScraper:
        ...
        for block in code_blocks:
            ...
            if "wallets" in code_text.lower() or "wallet" in code_text.lower():
                ...
                if block.parent and block.parent.get("class"):
                    ...
                    for lang_class in ["language-javascript", "language-python", "language-shell"]:
    ...
    def fetch_wallet_info(self) -> Dict[str, Any]:
        ...
        if "html" in data:
            ...
            self.wallet_info = {
                ...
                "description": "Hämtar information om alla plånböcker",
                "response_fields": [
                    {"name": "WALLET_TYPE", "description": "Typ av plånbok (exchange, margin, funding)"},
                    ...
                    {"name": "AVAILABLE_BALANCE", "description": "Tillgängligt saldo för handel"}
                ],
                "examples": []
            }
        ...
        if "html" in data:
            ...
            self.positions_info = {
                ...
                "response_fields": [
                    ...
                    {"name": "STATUS", "description": "Status för positionen (ACTIVE, CLOSED)"},
                    {"name": "AMOUNT", "description": "Mängd (positiv för long, negativ för short)"},
                    {"name": "BASE_PRICE", "description": "Genomsnittligt pris för positionen"},
                    {"name": "FUNDING", "description": "Finansiering som används för positionen"},
                    {"name": "FUNDING_TYPE", "description": "Typ av finansiering (0 för daily, 1 för term)"}
                ],
                "examples": []
            }
        ...
        if "html" in data:
            ...
            self.margin_info = {
                ...
                "response_fields": [
                    ...
                    {"name": "UNREALIZED_PL", "description": "Orealiserad vinst/förlust"},
    ...
    def generate_account_code_examples(self) -> Dict[str, Dict[str, str]]:
        ...
        examples = {
            "wallet": {
                "python": self._generate_wallet_example()
            },
            "positions": {
                "python": self._generate_positions_example()
            },
            "margin": {
                "python": self._generate_margin_example()
            }
        }
